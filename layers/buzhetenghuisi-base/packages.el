;;; packages.el --- buzhetenghuisi-base layer packages file for Spacemacs.
;;
...
;; added to `buzhetenghuisi-base-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `buzhetenghuisi-base/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `buzhetenghuisi-base/pre-init-PACKAGE' and/or
;;   `buzhetenghuisi-base/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst buzhetenghuisi-base-packages
  '(
    company
    youdao-dictionary
    helm-ag
...
(defun buzhetenghuisi-base/pre-init-company ()
...
(defun buzhetenghuisi-base/init-helm-ag ()
  (use-package helm-ag
    :defer t
    :init
    (progn
